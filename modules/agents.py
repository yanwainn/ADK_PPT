...
from utils.openai_client import get_gpt_client, get_gpt_model
from modules.models import ContentExtractionResult, VisualPrompt, KeySection
...
def get_content_extraction_prompt():
    ...
    Returns:
        str: Content extraction prompt
    """
    return """Extract 3-7 key sections from this document that would be excellent for presentation slides.
    For each section:
